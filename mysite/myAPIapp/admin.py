...
class CategoryAdmin(admin.ModelAdmin):
    """
    to display category class on admin panel
    """
...
class ProjectAdmin(admin.ModelAdmin):
    """
    to display project class on admin panel
    """
...
class PostCategoryAdmin(admin.ModelAdmin):
    """
    to display post category class on admin panel
    """
...
class StudentAdmin(admin.ModelAdmin):
    """
    to display student class on admin panel
    """
...
class CourseAdmin(admin.ModelAdmin):
    """
    to display course class on admin panel
    """
